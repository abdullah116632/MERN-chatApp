...
const UpdateProfile = () => {
  ...
  return (
    <div className="container backdrop-blur-lg rounded-lg border mx-auto p-4 text-gray-900 font-bold w-[65%]">
      <h2 className="text-3xl font-bold mb-4">Profile</h2>
      {!editMode ? (
        <>
          <div className="flex flex-col gap-3">
            <div className="flex items-center">
              <label className="w-1/4">Profile Picture:</label>
              <img
                src={user.profilePic}
                alt="Profile"
            ...
            <div className="flex items-center">
              ...
              <div className="flex-grow p-2 border border-emerald-900 rounded">
                {user.name}
              </div>
            </div>
            <div className="flex items-center">
              <label className="w-1/4">Email:</label>
              <div className="flex-grow p-2 border border-emerald-900 rounded">{user.email}</div>
            </div>
            <div className="flex items-center">
              <label className="w-1/4">Gender:</label>
              <div className="flex-grow p-2 border border-emerald-900 rounded">{user.gender}</div>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center">
            ...
            <input
              ...
              className="flex-grow p-2 border rounded bg-slate-200 border-stone-900"
            />
          </div>
          <div className="flex items-center">
            <label className="w-1/4">Email:</label>
